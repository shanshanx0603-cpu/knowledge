    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200">
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-[400px] p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-slate-400 mt-1">创建 Knowledge 账号</p>
        </div>
        ...
        <p className="text-xs text-slate-400 text-center mt-4">
          已有账号？<Link href="/login" className="text-indigo-500 hover:underline">登录</Link>
        </p>
      </div>
    </div>
  );
